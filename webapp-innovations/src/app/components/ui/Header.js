            ...
            <div className="mx-auto max-w-screen-xl px-4 sm:px-6 lg:px-8">
                <div className="flex h-16 items-center justify-between">
                    <div className="md:flex md:items-center md:gap-12">
                        ...
                        <div align="right">
                            <span className="ml-2 inline-block rounded-full bg-gradient-to-r from-pink-500 to-purple-500 px-3 py-1 text-[10px] font-medium text-white">
                                BETA
                            </span>
                            </div>
                    </div>
                    ...
                    <div className="hidden md:block" >
                        <NavigationMenu>
                            {/* commented on 12-2-24 */}
                            <NavigationMenuList >

                                {/* <NavigationMenuItem>
                                    <Link href="/innovations/about" legacyBehavior passHref>
                                        <NavigationMenuLink
                    ...
                    <div className="flex items-center gap-4">
                        ...
                        {/* commented on 12-2-24 for beta sheets */}
                        {/* {session ? (
                            ...
                            <Sheet>
                                ...
                                <SheetContent side="right">
                                    <nav className="grid gap-6 text-lg font-medium">
                                        ...
                                        <Link
                                            href="/innovations/events"
                                            className="text-muted-foreground hover:text-foreground"
                                        >
                                            Events
                                        </Link>
                                        <Link
                                            href="/innovations/register"
                                            className="text-muted-foreground hover:text-foreground"
                                        >
                                            Register
                                        </Link>
